    ...
    initializeButtons() {
        ...
        buttonArray.forEach(function(buttonConfig){
        	if (!buttonConfig.disabled) {
	            ...
	            let buttonService = this.accessory.getServiceByUUIDAndSubType(KeypadButtonSwitchService, label);
	            if (!buttonService) {
	                let buttonService = this.accessory.addService(KeypadButtonSwitchService, label, label);
	            }
	            this.accessory
	                .getServiceByUUIDAndSubType(KeypadButtonSwitchService, label)
	                .existsInConfig = true;
	        }        
        }.bind(this));
