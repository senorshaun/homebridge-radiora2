    ...
    initializeButtons() {
        ...
        buttonArray.forEach(function(buttonConfig){
        	if (!buttonConfig.disabled) {
	            ...
	            let service = this.accessory.getServiceById(Service.Switch, label);
	            if (!service) {
        ...
        this.accessory.services.forEach(function(accessoryService) {
            var thisButton = this.accessory.getServiceById(Service.Switch, accessoryService.displayName);
