...
module.exports = class KeypadButtonStateless {
    ...
    initializeButtons() {
        ...
        buttonArray.forEach(function(buttonConfig){
            if (!buttonConfig.disabled) {
                ...
                let service = this.accessory.getServiceById(Service.StatelessProgrammableSwitch, label);
                if (!service) {
                ...
                this.accessory
                    .getServiceById(Service.StatelessProgrammableSwitch, label)
                    .existsInConfig = true;
            }
        }.bind(this));

        this.accessory.services.forEach(function(accessoryService) {
            var thisButton = this.accessory.getServiceById(Service.StatelessProgrammableSwitch, accessoryService.displayName);
    ...
    trigger(buttonId, clickValue){
        ...
        var service = this.accessory.getServiceById(Service.StatelessProgrammableSwitch, "Button " + buttonId);
        if (service) {
